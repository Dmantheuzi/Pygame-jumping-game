...
pygame.display.set_caption("Jumpy Game by Dman")
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if pos[0] > 425 and pos[0] < 625 and pos[1] > 500 and pos[1] < 600:
                    ...
                    while Credits:
                        ...
                        text_surface, rect = game_font.render(("Programmer:"), (lightred))
                        gameDisplay.blit(text_surface, (250, 200))
                        text_surface, rect = game_font.render(("Dman "), (lightyellow))
                        gameDisplay.blit(text_surface, (220, 300))

                        game_font = pygame.freetype.Font("Font.ttf", 50)

                        text_surface, rect = game_font.render(("Check him out on Youtube"), (blue))
                        gameDisplay.blit(text_surface, (200, 450))

                        text_surface, rect = game_font.render(("Dman omg crae crae"), (lightblue))
...
def ChangeColor():
    ...
    ColorList = [(white),(yellow),(black),(blue),(lightblue),(lightgreen),(lightred),(green),(lightyellow),(green),(purple),(hotpink),"rainbow"]
    num = 0
    RainbowNum = 0
...
def draw(x,y,Obj):
    ...
    if Obj == "platform":
        pygame.draw.rect(gameDisplay,(lightgreen),(x,y,200,20),0)
        pygame.draw.rect(gameDisplay,(lightblue),(x,y,200,20),5)
    if Obj == "player":
        if CurColor != "rainbow":
